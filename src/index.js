...
async function startBot() {
    ...
    async function refreshTicketPanel(channelId) {
        ...
        // --- بداية التعديل: إضافة تذكرة الإعلانات و Reset Menu ---
        const select = new StringSelectMenuBuilder()
            ...
            .addOptions([
                ...
                { label: 'إعلان', value: 'advertisement', emoji: '📢' }, // إضافة تذكرة الإعلانات
                { label: 'Reset Menu', value: 'reset_menu', emoji: '🔄' }, // إضافة Reset Menu
            ]);
        // --- نهاية التعديل ---
    ...
    client.on(Events.InteractionCreate, async interaction => {
        try {
            ...
            if (interaction.isStringSelectMenu() && interaction.customId === 'ticket_select') {
                ...
                // --- بداية التعديل: التعامل مع Reset Menu ---
                ...
                // --- دالة مساعدة لإنشاء التذاكر لتجنب تكرار الكود ---
                ...
                // --- بداية التعديل: منطق تذكرة الإعلانات ---
                if (selectedValue === 'advertisement') {
                    // !! مهم: قم بتغيير هذه الأرقام إلى الأرقام الصحيحة في سيرفرك
                    const adsRoleId = '1419306155145953400'; // آي دي رول مسؤولي الإعلانات
                    const adsCategoryId = '1397022492090171392'; // آي دي كاتيجوري تذاكر الإعلانات

                    await createTicket('ads', adsRoleId, adsCategoryId, {
                        title: 'تذكرة إعلان',
                        image: 'https://media.discordapp.net/attachments/1433832273538711612/1436075334565888010/image.png?ex=690e48e0&is=690cf760&hm=88ebb29ea8c00615c80da44823be56fd7d06367e88e4fb21980e1af0b7f543e0&=&format=webp&quality=lossless&width=963&height=320', // يمكنك تغيير الصورة
            ...
            // =================== الجزء المصحح والمطور لاستلام جميع أنواع التذاكر ===================
            if (interaction.isButton() && interaction.customId === 'ticket_claim') {
                ...
                // --- بداية التعديل: إرسال رسالة خاصة للإداري ---
                try {
                    await member.send({
                    ...
                    // إرسال رسالة في القناة كبديل إذا كانت الرسائل الخاصة مغلقة
