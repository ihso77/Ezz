...
// =================================================================================
// --- بداية: دمج وظائف إدارة ملف claim.json في الملف الرئيسي ---
// =================================================================================
...
/**
 * دالة لقراءة بيانات الاستلام من الملف
 * @returns {Object} كائن يحتوي على بيانات الاستلام
 */
function readClaims() {
    try {
        ...
        return {}; // إرجاع كائن فارغ لتجنب تعطل البوت
    }
}

/**
 * دالة لكتابة بيانات الاستلام إلى الملف
 * @param {Object} data البيانات المراد كتابتها
 */
function writeClaims(data) {
    try {
        // null, 2 لتنسيق الملف وجعله قابلاً للقراءة
...
/**
 * دالة لزيادة عدد استلامات إداري معين وإرجاع العدد الجديد
 * @param {string} adminId آي دي الإداري
 * @returns {number} العدد الجديد للاستلامات
 */
...
// =================================================================================
// --- نهاية: دمج وظائف إدارة ملف claim.json ---
// =================================================================================
    ...
    client.on(Events.InteractionCreate, async interaction => {
        try {
            ...
            if (interaction.isButton() && interaction.customId === 'ticket_claim') {
                ...
                // تحقق إذا كان المستخدم لديه صلاحيات إدارة الرومات
                ...
                // --- زيادة العداد والحصول على العدد الجديد ---
                const newClaimCount = incrementClaimCount(member.id);

                // إنشاء زر استلام جديد معطل
